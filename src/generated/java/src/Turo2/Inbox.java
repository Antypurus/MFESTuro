...
public class Inbox implements EvaluatePP {
  ...
  public VDMSet getNotViewedNotifications() {
    ...
    try {
      ...
      for (Iterator iterator_9 = retNotifications.iterator(); iterator_9.hasNext(); ) {
        Notification notification = (Notification) iterator_9.next();
  ...
  public VDMSet viewNotifications() {
    ...
    try {
      for (Iterator iterator_10 = notifications.iterator(); iterator_10.hasNext(); ) {
        Notification notification = (Notification) iterator_10.next();
