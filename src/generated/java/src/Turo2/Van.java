...
public class Van extends Car implements EvaluatePP {

  public static class Van_sentinel extends Car_sentinel {
    ...
    public Van_sentinel(final EvaluatePP instance) {
  ...
  private static final Object CAR_TYPE = Turo2.quotes.VANQuote.getInstance();
  ...
  public void cg_init_Van_1(
    ...
    sentinel = new Van_sentinel(this);
    name = m_name;
    ...
    numberOfDoors = Van.NUMBER_OF_DOORS;
    numberOfSeats = Van.NUMBER_OF_SEATS;
    vehicleType = Van.CAR_TYPE;
  ...
  public void calculatePricePerDay() {
    ...
    sentinel.entering(((Van_sentinel) sentinel).calculatePricePerDay);
    try {
      Number dayPrice = Van.BASE_VALUE;
      for (Iterator iterator_5 = features.iterator(); iterator_5.hasNext(); ) {
        Feature feature = (Feature) iterator_5.next();
      ...
      sentinel.leaving(((Van_sentinel) sentinel).calculatePricePerDay);
    }
  }
